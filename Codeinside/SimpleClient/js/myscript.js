...
$(document).ready(function () {
    ...
    function get_allowed_books(callback){
        ...
        $.ajax({
            url: basic_part_url + "/book/get-allowed-book",
            data: {
                'userId': userId
            },
            method: "get",
    ...
    function deleteShelf(event){
        ...
        $.ajax({
            url: basic_part_url + "/shelf/delete",
            method: "post",
            data: {'id': id},
            success:function () {
        ...
        $('#changeShelf').arcticmodal({
            ...
            overlay: {
             ...
             afterClose: function(data, el) {
                 ...
                 $.ajax({
                     url: basic_part_url + "/book/change-shelf",
                     method: "post",
    ...
    $("#btn-search-book").click(function () {
        ...
        if (shelf_search.val()  != undefined && shelf_search.val() != '') {
            $.ajax({
                ...
                url: basic_part_url +"/book/search-another-people-book",
                method: "get",
                success: function (data) {
                    var result = data;
                    var optional = "<table>";
    ...
    function openModalRequestBook(event){
        ...
        $('#requestBook').arcticmodal({
            ...
            afterClose: function(data, el) {
                ...
                $.ajax({
                    url: basic_part_url +"/request/made-request-book",
                    method: "post",
    ...
    $("#btn-request-view").click(function () {
        userId = localStorage.getItem("userId");
            $.ajax({
                ...
                url: basic_part_url + "/request/get-not-answered-request",
                method: "get",
                success: function (data) {
                    var result = data;
                    var optional = "<table>";
    ...
    function openModalAnswerBook(event){
        ...
        $('#responseBook').arcticmodal({
            ...
            afterClose: function(data, el) {
                ...
                $.ajax({
                    url: basic_part_url + "/request/made-response-book",
                    method: "post",
    ...
    $("#back").click(function () {
        if(currentPage > 0 && openBookId != "") {
            currentPage--;
            $.ajax({
                url: basic_part_url + "/book/book-page",
                method: "post",
